...
# Maecenas pharetra purus ipsum, eget consequat ipsum lobortis quis. Phasellus eleifend
# ex auctor venenatis tempus.Aliquam vitae erat ac orci placerat luctus. Nullam elementum urna
# nisi,pellentesque iaculis enim cursus in.Praesent volutpat porttitor magna, non finibus neque
# cursus id.
def index(request):
